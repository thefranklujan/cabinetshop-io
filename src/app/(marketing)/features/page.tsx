...
import { Users, Hammer, Trello, Boxes, Scissors, ShoppingCart, Clock, Calendar, Receipt, BarChart3, Shield, Zap, ShieldCheck, ListTodo, MessageSquare } from "lucide-react";
...
const FEATURES = [
  ...
  { i: ShoppingCart, t: "Purchase Orders", d: "Track POs to suppliers through Draft → Sent → Confirmed → Received → Closed, with expected delivery dates, linked to specific jobs." },
  { i: ShieldCheck, t: "Approval Gates & Readiness", d: "Nine approval gates and a readiness checklist stand between a job and production. Nothing releases to the floor missing a deposit, drawings, or a field measure." },
  { i: ListTodo, t: "Tasks & Constraints", d: "The shop's daily to-do list, plus a constraints board that shows exactly which jobs are waiting on a client, vendor, material, or install date, sorted by age." },
  { i: MessageSquare, t: "Job Timeline", d: "A per-job record of approvals, notes, and client responses. When someone asks who approved the finish and when, the answer is on the timeline." },
  ...
  { i: Shield, t: "Multi-Tenant Security", d: "Postgres Row Level Security on every table, enforced by the database on every query. Your shop's data is invisible to every other shop on the platform." },
];
    ...
    <>
      ...
      <section className="border-t border-line py-24 text-center">
        <div className="max-w-[700px] mx-auto px-7">
          ...
          <p className="text-neutral-400 mt-4">Free while we are in pilot. No credit card.</p>
          <Link
            href="/sign-up"
